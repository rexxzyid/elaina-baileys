...
<div align="center">
  ...
  <p>
  <!-- NPM Version -->
  <a href="https://www.npmjs.com/package/@rexxzyid/elaina-baileys">
    <img src="https://img.shields.io/npm/v/@rexxzyid/elaina-baileys?color=blueviolet&label=version&logo=npm" alt="npm version" />
  </a>

  <!-- NPM Downloads -->
  <a href="https://www.npmjs.com/package/@rexxzyid/elaina-baileys">
    <img src="https://img.shields.io/npm/dt/@rexxzyid/elaina-baileys?color=blueviolet&label=downloads&logo=npm" alt="npm downloads" />
  </a>

  <!-- License -->
  <a href="https://www.npmjs.com/package/@rexxzyid/elaina-baileys">
    <img src="https://img.shields.io/npm/l/@rexxzyid/elaina-baileys?color=success&label=license" alt="license" />
  </a>

  <!-- Bundle Size -->
  <a href="https://bundlephobia.com/package/@rexxzyid/elaina-baileys">
    <img src="https://img.shields.io/bundlephobia/min/@rexxzyid/elaina-baileys?label=minified%20size&color=orange" alt="bundle size" />
  </a>

  <!-- Gzip Bundle Size -->
  <a href="https://bundlephobia.com/package/@rexxzyid/elaina-baileys">
    <img src="https://img.shields.io/bundlephobia/minzip/@rexxzyid/elaina-baileys?label=minzip%20size&color=orange" alt="gzip bundle size" />
  </a>

  <!-- PackagePhobia Install Size -->
  <a href="https://packagephobia.com/result?p=@rexxzyid/elaina-baileys">
    <img src="https://packagephobia.com/badge?p=@rexxzyid/elaina-baileys" alt="install size" />
  </a>
  ...
  <!-- Node Engine Support -->
  <img src="https://img.shields.io/node/v/@rexxzyid/elaina-baileys?label=node%21engine" alt="node engine" />

  <!-- Types -->
  <img src="https://img.shields.io/npm/types/@rexxzyid/elaina-baileys?label=types" alt="types" />
</p>

<p>
  <!-- WhatsApp Channel -->
  <a href="https://whatsapp.com/channel/0029VbBdVbVGJP8K5d9LiN0q">
...
Fork Baileys (NPM) **@whiskeysockets/baileys** / **@adiwajshing/baileys** [ NOT AVAILABLE UPDATE ]

```json
@whiskeysockets/baileys
"dependencies": {
    "@whiskeysockets/baileys": "npm:@rexxzyid/elaina-baileys"
}
```
```json
@adiwajsing/baileys
"dependencies": {
    "@adiwajshing/baileys": "npm:@rexxzyid/elaina-baileys"
}
```

Fork Baileys (github) **@whiskeysockets/baileys** / **@adiwajshing/baileys** [ AVAILABLE UPDATE ]

```json
@whiskeysockets/baileys
"dependencies": {
    "@whiskeysockets/baileys": "github:@rexxzyid/elaina-baileys"
}
```
```json
@adiwajsing/baileys
"dependencies": {
    "@adiwajshing/baileys": "github:@rexxzyid/elaina-baileys"
}
```

Or via terminal non fork
```bash
npm install elaina-bail@npm:@rexxzyid/elaina-baileys
```
...
> ESM
```bash
import makeWASocket from '@rexxzyid/elaina-baileys
```

> CJS
```bash
const { default: makeWASocket } = require('@rexxzyid/elaina-baileys')
```
---
🌟 Key Features
...
- **rexxzyid (Saya)** — pengembang utama proyek ini.
