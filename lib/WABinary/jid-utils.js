...
export const LOCATION_BROADCAST_JID = 'location@broadcast';
...
export const isJidStatusBroadcast = (jid) => jid === STORIES_JID;
export const isJidLocationBroadcast = (jid) => jid === LOCATION_BROADCAST_JID;
