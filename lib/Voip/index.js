...
class VoipClient {
    constructor(config = {}) {
        ...
        this.call = async (phoneNumber, opts = {}) => {
            ...
            const peerDeviceJids = await this._signaling.discoverPeerDevices(peerLid);
            ...
            const tcToken = await this._signaling.ensureTcToken(peerLid, targetPnJid);
        ...
        this._initVoipStack = async () => {
            ...
            this._signaling = new signaling_js_1.SignalingBridge({
                sock: this._sock
            });
            ...
            this._engine = new wasm_engine_js_1.WasmEngine({
                callbacks: {
                    onSignalingXmpp: (peerJid, callId, xmlPayload) => this._signaling.sendSignaling(peerJid, callId, xmlPayload),
            ...
            const selfPnJid = this._sock.authState.creds.me?.id;
            const selfLidJid = this._sock.authState.creds.me?.lid;

            this._engine.initVoipStack(selfPnJid, toBareJid(selfPnJid), selfLidJid);
