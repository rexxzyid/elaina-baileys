...
export const makeSocket = (config) => {
    ...
    const fetchNewChatMessageCap = async () => {
        const response = await executeWMexQuery({ input: { type: 'INDIVIDUAL_NEW_CHAT_MSG' } }, QueryIds.MESSAGE_CAPPING_INFO, XWAPaths.xwa2_message_capping_info, query, generateMessageTag);
