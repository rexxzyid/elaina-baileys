...
export const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        ...
        /**
         * The server answers companion_hello with the pairing ref it registered.
         * Without that ref nothing was registered, so the code on screen would be
         * dead and the phone would never be told to show the link prompt.
         */
        if (!response) {
            clearPendingPairing();
