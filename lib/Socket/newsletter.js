...
export const makeNewsletterSocket = (config) => {
    ...
    return {
        ...
        newsletterAdminInfo: async (jid) => {
            return executeWMexQuery({ newsletter_id: jid }, QueryIds.ADMIN_INFO, XWAPaths.admin_profile);
        },
        ...
        newsletterPendingAdminInvites: async (jid) => {
            return executeWMexQuery({ newsletter_id: jid }, QueryIds.PENDING_ADMIN_INVITES, XWAPaths.pending_admin_invites);
        },
