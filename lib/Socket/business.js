...
const { makeNewsletterUtils } = require("../Utils/messages-newsletter")
...
const makeBusinessSocket = (config) => {
    ...
    const newsletterUtils = makeNewsletterUtils(sock)
    sock.newsletterMessage = newsletterUtils.newsletterMessage
