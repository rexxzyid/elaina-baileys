...
import { commitSenderKeyDelivery, pickSenderKeyRecipients } from '../Utils/sender-key-memory.js';
...
export const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        resetGroupSenderKey: async (jid) => {
            ...
            logger.info({ jid }, 'cleared sender key memory, the next send redistributes the key');
        },
        updateMemberLabel,
