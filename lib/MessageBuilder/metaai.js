...
export const forwardRichResponse = async (sock, jid, msg, { quoted, contextInfo, messageId, additionalNodes = [], ...options } = {}) => {
    const signed = readSignedRichResponse(msg)
    if (!signed) {
    ...
    const content = {
        ...
        botForwardedMessage: { message: { richResponseMessage: relayed } }
    }
