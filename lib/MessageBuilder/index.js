...
export { VERSION as MESSAGE_BUILDER_VERSION, Button, ButtonV2, Carousel, AIRich, Toolkit };

export const MessageBuilder = Object.freeze({ VERSION, Button, ButtonV2, Carousel, AIRich, Toolkit });
