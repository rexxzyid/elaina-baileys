...
export const SERVER_ERROR_CODES = {
    ...
    SmaxInvalid: '479',
    /**
     * New-chat message quota reached. WhatsApp keeps existing conversations
     * working and only blocks starting new ones, so this is not fatal and the
     * quota lifts on its own.
     */
    NewChatMessagesCapped: '475'
};
/**
 * Ack error codes that mean "try again later" rather than "this message is
 * wrong". Everything else is a permanent rejection and must not be resent:
 * retrying a permanent failure counts as another reach-out and can make an
 * account restriction worse.
 */
