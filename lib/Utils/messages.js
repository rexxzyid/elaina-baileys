...
const generateWAMessageContent = async (message, options) => {
    ...
    var _p, _q;
    let m = {};
    if ('botForwardedMessage' in message && !!message.botForwardedMessage) {
        m.botForwardedMessage = Types_1.WAProto.Message.FutureProofMessage.fromObject(message.botForwardedMessage);
    }
    else if ('richResponseMessage' in message && !!message.richResponseMessage) {
        m.richResponseMessage = Types_1.WAProto.AIRichResponseMessage.fromObject(message.richResponseMessage);
    }
    ...
    if ('messageContextInfo' in message && !!message.messageContextInfo) {
        m.messageContextInfo = Types_1.WAProto.MessageContextInfo.fromObject(message.messageContextInfo);
    }
