...
export const DEFAULT_MAX_EVENT_LISTENERS = 64;

export const makeEventBuffer = (logger, maxListeners = DEFAULT_MAX_EVENT_LISTENERS) => {
    const ev = new EventEmitter();
    ev.setMaxListeners(Number.isFinite(maxListeners) && maxListeners >= 0 ? maxListeners : DEFAULT_MAX_EVENT_LISTENERS);
    ...
    return {
        ...
        addListener: (...args) => ev.addListener(...args),
        removeListener: (...args) => ev.removeListener(...args),
        removeAllListeners: (...args) => ev.removeAllListeners(...args),
        setMaxListeners: (count) => ev.setMaxListeners(count),
        getMaxListeners: () => ev.getMaxListeners(),
