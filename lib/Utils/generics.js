...
exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestElainaVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
...
const fetchLatestElainaVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/@rexxhayanasi/elaina-baileys', {
            ...options,
            responseType: 'json'
        });
...
exports.fetchLatestElainaVersion = fetchLatestElainaVersion;

const fetchLatestBaileysVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/baileys', {
            ...options,
            responseType: 'json'
        });
        const versionStr = data.version; 
